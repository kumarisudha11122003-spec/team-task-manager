        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              disabled={loading}
              className="w-full mt-2 py-3.5 px-4 rounded-xl bg-gradient-to-r from-[#7C3AED] to-[#4F46E5] text-white font-medium shadow-[0_10px_40px_rgba(124,58,237,0.45)] hover:shadow-[0_10px_50px_rgba(124,58,237,0.6)] flex items-center justify-center gap-2 transition-all disabled:opacity-70 disabled:cursor-not-allowed"
            >
              {loading ? (
